      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            ...
            <a href="#" className="text-sm text-orange-500 hover:text-orange-500 font-medium">
              Forgot password?
            </a>
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-orange-500 text-white font-semibold py-3 px-4 rounded-lg hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-all duration-200"
          >
            Sign in
          </button>
        </form>
        ...
        <div className="text-center">
          <p className="text-gray-600">
            ...
            <Link to="/signup" className="font-medium text-orange-500 hover:text-orange-500">
              Sign up for free
            </Link>
          </p>
        </div>
