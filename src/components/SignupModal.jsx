    ...
    try {
      ...
      setTimeout(async () => {
        try {
          ...
          localStorage.setItem('userName', loginResponse.user.name || loginResponse.user.email);
          localStorage.setItem('userId', loginResponse.user._id || loginResponse.user.id);
          
          closeModals();
          window.location.reload();
        } catch (err) {
          // If auto-login fails, just close modal
          closeModals();
        }
      }, 1500);
    } catch (err) {
        ...
        <div className="p-6 sm:p-8">
          ...
          {success && (
            <div className="mb-4 p-4 bg-green-50 border border-green-200 rounded-lg">
              <p className="text-sm text-green-600">Account created successfully! Logging you in...</p>
            </div>
          )}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-colors duration-200 ${
