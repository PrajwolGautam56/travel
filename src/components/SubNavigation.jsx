...
const SubNavigation = () => {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-2xl p-4 md:p-6 w-[1268px]
        // max-w-8xl 
        mx-auto
         ">
            ...
            <div className="flex flex-wrap gap-1 mb-4">
                {navigationItems.map((item) => (
                    <button
                        ...
                        className={`sub-nav-tab px-5 py-2.5 text-sm font-medium rounded-t-lg transition-all duration-200 ${activeTab === item
