    ...
    <footer className="bg-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-300">support@skyways.com</span>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 text-blue-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Flights */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-blue-400">Flights</h3>
          ...
          {/* Hotels */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-blue-400">Hotels</h3>
            <ul className="space-y-2">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="max-w-md">
            <h3 className="text-lg font-semibold mb-4 text-blue-400">Subscribe to Our Newsletter</h3>
            <p className="text-gray-300 mb-4">Get the latest travel deals and offers delivered to your inbox.</p>
            <div className="flex">
              <input
                type="email"
