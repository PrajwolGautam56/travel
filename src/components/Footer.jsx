          ...
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <div className="space-y-2 sm:space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-xs sm:text-sm text-gray-300">+91 1800-123-4567</span>
              </div>
              <div className="flex items-center">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-orange-400 mr-2 sm:mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-xs sm:text-sm text-gray-300">support@skyways.com</span>
              </div>
              <div className="flex items-center">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-orange-400 mr-2 sm:mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-xs sm:text-sm text-gray-300">Mumbai, Maharashtra, India</span>
              </div>
            </div>
          </div>
